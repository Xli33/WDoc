...
$.canvasProgress__ = function(options){
	var lightLoader = function(c, cw, ch,){
		...
		this.renderLoader = function(){
			...
			this.ctx.fillStyle = options.barColor || '#66b3f5' || 'hsla('+this.hue+', 100%, 40%, 1)';
		...
		this.Particle.prototype.render = function(){
			_this.ctx.fillStyle = options.particlesColor || '#66b3f5' || 'hsla('+this.hue+', 100%, '+_this.rand(50,70)+'%, '+_this.rand(20,100)/100+')';
	...
	if(isCanvasSupported){
	  ...
	  var cw = c.width;
	  var ch = c.height;
	  options.target.length ? options.target.append(c).data('progress',c) : document.body.appendChild(c);
