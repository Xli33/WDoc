	...
	Datepicker.prototype = {
      ...
      var element = this.component ? this.element.find('input') : this.element;
		...
		setDates: function(){
			...
			this._trigger('changeDate');
			this.setValue(); console.log(this)
			return this;
		},
		...
		setValue: function(){
			...
			this.o.getWeekEndDate = this.dates[0] ? this.dates[0].toISOString() : null;
			// console.log(this);
			return this;
		},
		...
		getFormattedDate: function(format){
			if (this.o.weekPicker) {
				...
				if (format === undefined) format = this.o.format;console.log(DPGlobal.formatDate(d, format, lang))
		...
		place: function(){
			...
			var offset = this.component ? this.component.parent().offset() : this.element.parent().offset();
			...
			// edge, fudge it sideways
				...
				} else if (left + calendarWidth > windowWidth) {//console.log(calendarWidth)
				...
				if (prevMonth.getUTCDay() === this.o.weekStart){
					...
					if (this.o.calendarWeeks){
						...
						var
							...
							// th = new Date(Number(ws) + (7 + 1 - ws.getUTCDay()) % 7 * 864e5),
							// First Thursday of year, year from thursday
							// yth = new Date(Number(yth = UTCDate(th.getUTCFullYear(), 0, 1)) + (7 + 1 - yth.getUTCDay())%7*864e5),
							// Calendar week: ms between thursdays, div ms per day, div 7 days
							// calWeek =  (th - yth) / 864e5 / 7 + 1 + 0;
							// console.log(ws);
							calWeek = moment(ws).weeks();
